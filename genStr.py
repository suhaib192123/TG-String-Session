...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@stringsession_genbot](tg://openmessage?user_id=1472531255) \nA Bot By @kashir_bots")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/Dsrs_Group'),
                InlineKeyboardButton('Developer', url='https://t.me/kashmir_1')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/kashir_bots'),
            ]
        ]
    )
